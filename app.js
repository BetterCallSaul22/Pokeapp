...
const combate = ()=>{
    console.log("Están peleando lmao")
        //Hasta el momento faltan la mitad de los tipos (10/20)
    ...
    const efectividad = (tipoAtaque, tipo1, tipo2) => {
        //Esta variable devuelve el multiplicador de efectividad
        let multiplicador;

        //Verificar si el pokemon tiene dos tipo

        
        //Buscar el multiplicador en la tabla por cada tipo e irlo sumando a la variable multiplicador
